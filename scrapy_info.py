...
def get_detail_info(browser,job):
    """获得岗位详细页信息：公司介绍、公司成立日期、岗位介绍、岗位地址、投递网址"""
    ...
    tab2.close()
    return brand_des, brand_time, job_des, apply_url, job_address
...
def get_total_info(browser,job):
    ...
    brand_des, brand_time, job_des, apply_url, job_address = get_detail_info(browser, job)
    job_info = {
            "公司名称": brandName,
            "公司成立日期": brand_time,
            "公司规模": brandScale,
