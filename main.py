...
/* 4. 鼠标悬浮 (Hover) 及 获得焦点 (Focus) 保持白色，边框加深 */
div[data-testid="stSelectbox"] [data-baseweb="select"]:hover > div,
div[data-testid="stMultiSelect"] [data-baseweb="select"]:hover > div {
    background-color: #FFFFFF !important;
...
# 问卷区：15 个小问题（保留原有逻辑）
# =============================================================================
st.markdown('<div class="section-header">❔️ 15个小问题</div>', unsafe_allow_html=True)
...
# =============================================================================
st.markdown('<div class="section-header">📊 结果喵 </div>', unsafe_allow_html=True)
