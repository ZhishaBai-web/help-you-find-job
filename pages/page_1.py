...
/* =====================================================================
   ...
   ===================================================================== */
.stApp {
    background: linear-gradient(135deg, #fff7fb 0%, #f1f8ff 25%, #f0f4ff 50%, #fff0f7 75%, #fff7fb 100%);
...
.stTextInput > div > div > input {
    ...
    border: 2px solid rgba(168, 216, 255, 0.35) !important;
...
.stTextInput > div > div > input:focus {
    border-color: var(--tech-blue) !important;
    box-shadow: 0 0 0 4px rgba(88, 101, 242, 0.08) !important;
...
st.title("爬虫喵 · 漏网之猫")
st.markdown(
    '<p class="hero-subtitle">🐱 让爬虫喵帮您捕猎理想岗位，精准抓取不遗漏 喵 ~</p>',
    unsafe_allow_html=True
)
...
# 🐾 Card 1: 岗位搜索中心
# =============================================================================
st.markdown('<div class="card-header">🐾 岗位搜索中心</div>', unsafe_allow_html=True)
...
st.markdown('<div class="card-header">⚙️ 捕猎参数配置</div>', unsafe_allow_html=True)

# ---- 第一行：城市、类型、薪资、经验、学历、规模 ----
col1, col2, col3,col4, col5, col6 = st.columns([1,1,1.1,1.1,1,1.1])
with col1:
    st.markdown('<span class="radio-label-icon">🏙 城市期望</span>', unsafe_allow_html=True)
...
# 🚀 Card 3: 猫爪采集中心
# =============================================================================
st.markdown('<div class="card-header">🚀 猫爪采集中心</div>', unsafe_allow_html=True)
...
with btn_col2:
    submit = st.button("🐾 开始捕猎岗位", key="start_crawl_button")
